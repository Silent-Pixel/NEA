...
public class LevelSystem extends ApplicationAdapter {
    ...
    public void create() {
        ...
        CurrentLevel = new int[31][18];
        try {
            CurrentLevel = ReadLevel2DArray();
    ...
    public static int[][] ReadLevel2DArray() throws FileNotFoundException{
        int[][] matrix = new int[31][18];
        Scanner sc = new Scanner(new File("assets/Level2DArray.txt"));
